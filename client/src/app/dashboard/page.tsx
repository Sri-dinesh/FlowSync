...
const DEFAULT_FALLBACK_DATA: DashboardPayload = {
  ...
  sessions: [
    {
      session_id: "session_ai_37f6",
      created_at: "2026-09-19 18:30:00",
      ...
      level_of_service: "B",
      efficiency_gain_pct: 57.4,
    },
    {
      session_id: "session_greedy_08a1",
      created_at: "2026-09-19 17:15:00",
      ...
      has_arrivals: true,
      mode: "greedy",
      model_name: "Greedy Pressure Controller",
      throughput: 73,
      throughput_pct: 91.3,
      avg_wait_s: 27.8,
      peak_queue: 7,
      performance_rating: "EFFICIENT",
      level_of_service: "C",
      efficiency_gain_pct: 27.8,
    },
    {
      session_id: "session_fixed_9b2e",
